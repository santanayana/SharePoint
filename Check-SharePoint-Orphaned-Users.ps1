...
function StartProcess()
{
	...
	ListOrphanedUsersForAllColl "http://myWebApplication01" "LDAP://DC=MyDomain,DC=com"
	ListOrphanedUsersForAllColl "http://myWebApplication02" "LDAP://DC=MyDomain,DC=com"
